...
const ADMIN_SITE_URL = process.env.ADMIN_SITE_URL || "https://starlit-tartufo-1d180f.netlify.app/admin.html";
...
const paymentLabel = (m) =>
  ({ cod: "Thanh toán khi nhận hàng (COD)", transfer: "Chuyển khoản", momo: "Ví MoMo" }[m] || m);
